...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('loan_date', models.DateTimeField(verbose_name=datetime.datetime(2016, 9, 6, 19, 40, 2, 299252))),
                ('return_date', models.DateTimeField(verbose_name=datetime.datetime(2016, 9, 13, 19, 40, 2, 299305))),
